...
3.- Move ScriptEditorWindow.cs to that folder.

4.- On Unity, you'll see a new Tools menu, open that and select Script Editor.

5.- Create a C# script as usual, drag that script on Script field.

6.- Edit as you please.

7.- Save, and probably Recompile.
